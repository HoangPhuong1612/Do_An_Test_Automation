...
public class GuiCanBoBienTapXuatBan_Test extends BaseTest {
    LoginPage loginPage;
    ...
    public void xuatBanNgayTinBai(){
        ...
        WebUI.sleep(7);
        WebUI.clickElement(canBoBienTapPage.tieuDe1);
        WebUI.sleep(3);
        WebUI.clickElement(canBoBienTapPage.buttonXuatBan);
        WebUI.sleep(3);
        WebUI.clickElement(canBoBienTapPage.buttonDongY);
        WebUI.waitForPageLoaded(driver);
        WebUI.sleep(10);

        WebUI.clickElement(canBoBienTapPage.menuDaXuatBan);
        WebUI.waitForPageLoaded(driver);
        WebUI.sleep(5);
