...
public class CanBoBienTap_Page extends CommonPage{

    //khai báo driver cục bộ chính cho class
    public WebDriver driver;

    //Hàm xây dựng
    public CanBoBienTap_Page(WebDriver driver) {
        super(driver);
        this.driver = driver;
    }
    ...
    public By buttonXuatBan= By.xpath("//button[@id='32027eb1-91c8-43b0-9feb-53df727962cc']");
    public By buttonGuiCanBoPheDuyet = By.xpath("//button[@id='btnSendMultiBanBienTap']");
    ...
    public By checkbox1= By.xpath("//tbody//tr[1]//td[9]//input");
